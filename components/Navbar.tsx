...
export function Navbar() {
  ...
  useEffect(() => {
    ...
    const handler = (e: MediaQueryListEvent) => {
      // Ignore viewport-width changes caused by a scrollbar appearing/disappearing
      // while a Base UI popup (Menu defaults to modal: true) has scroll locked —
      // that shifts window.innerWidth without the user actually resizing anything,
      // and reacting to it would unmount this section mid-interaction.
            ...
            {!effectiveCollapsed && (
              <>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger
                    render={
                      <Button variant="ghost" size="iconSm" aria-label="Account menu" />
                    }
                  >
                    <MoreVertical />
                  </DropdownMenuTrigger>
